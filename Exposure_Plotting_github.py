...
##############################################################################
# This is to draw the new figures and not calculate the exposure
##############################################################################
...
# open pixel data csv
prm_dir1 = ('D:/mydirectory/')
orbit_number = '20418' # example
pixel_results = '2021_09_21_' + orbit_number + '_pixel_results.csv' # example
